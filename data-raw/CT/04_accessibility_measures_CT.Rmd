...
```{r read-ttm}
ttm <- read_csv(paste0(here(),"/data-raw/aux-files/PCD3520/CT/travel_times/ttm.csv"),
                col_types = cols(
...
```{r directory-export}
diretorio_export <- paste0(here(),"/data-raw/aux-files/PCD3520/CT/output/") # Update the address to export the data, if necessary
