...
```{r}
output_folder <- paste0(here::here(),"/data-raw/aux-files/PCD3520/CT/output/")
```
...
```{r}
directory_ct <- paste0(here(), "/data-raw/aux-files/PCD3520/CT/") # Update this address if necessary
census_tracts <-   st_read(paste0(directory_ct, "census_tracts.shp"))
```
