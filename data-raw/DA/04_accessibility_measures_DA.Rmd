...
```{r read-ttm}
ttm <- read.csv(paste0(here(),"/data-raw/aux-files/PCD3520/DA/travel_times/ttm.csv")) # Travel time table address
```
...
```{r directory-export}
diretorio_export <- paste0(here(),"/data-raw/aux-files/PCD3520/DA/output/") # Update the address to export the data, if necessary
