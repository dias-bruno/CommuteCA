...
```{r}
directory_da <- paste0(here(), "/data-raw/aux-files/PCD3520/DA/") # Update this address if necessary
dissemination_areas <-   st_read(paste0(directory_da, "dissemination_areas.shp"))
```

Reading the census_divisions geometries:

```{r}
directory_cd <- paste0(here(), "/data-raw/aux-files/PCD3520/") # Update this address if necessary
census_divisions <-   st_read(paste0(directory_cd, "census_divisions.shp"))
```
