...
#'
#' @format A simple feature class (sf) polygon object containing 6,247 rows and 10 variables; each row represents a unique CT with associated geo-referenced geometry.
#'   \describe{
...
#'   \item{DGUID}{Census Tract Geography Unique Identifier.}
...
#'}
#' @docType data
#' @keywords census tract
#' @name census_tracts_ca21
#' @usage data(census_tracts_ca21)
...
#' Toronto job accessibility (Hansen type)
#'
#' This object contains the value of job accessibility for the City of Toronto, at the level of Dissemination Areas (DAs).
#' The measures were obtained applying the Hansen type metric, using the Census of Population (2021) as data source.
#'
...
#'   \item{HT_i}{DA job accessibility (Hansen Type).}
#'}
#' @docType data
...
#' Toronto job accessibility (Hansen type) by mode
#'
#' This object contains the value of job accessibility for the City of Toronto, at the level of Dissemination Areas (DAs),
...
#'   \item{PRCDDA}{Uniquely identifies a dissemination area (composed of the 2-digit province/territory unique identifier followed by the 2-digit census division code and the 4-digit dissemination area code).}
#'   \item{PwMode}{Transportation mode. Possible values: 'Bike', 'Car', 'Transit', and 'Walk.'}
#'   \item{HT_im}{DA job accessibility (Hansen Type).}
#'}
#' @docType data
#' @keywords Toronto Hansen accessibility dissemination area mode transportation
...
#'   \item{loglik}{Log-Likelihood obtained for the function 'distribution.'}
...
#'   \describe{
#'   \item{Pr}{Province or Territory.}
#'   \item{CMA}{Type of Census Metropolitan Area or Census Agglomeration (Possible values: 'Territories (outside CAs)','CMA/CA','Strong metropolitan influenced zone', 'Moderate metropolitan influenced zone','Weak metropolitan influenced zone', or 'No metropolitan influenced zone').}
#'   \item{PwMode}{Transportation mode. Possible values: 'Bike', 'Car', 'Transit', and 'Walk.'}
#'   \item{distribution}{Name of the function that best adjusted the duration values considering the specific location and transportation mode (can be "exponential", "norm", “lnorm”, “gamma” or “unif”)}.
#'   \item{est_1}{Estimate of the first parameter for the function described in 'distribution.'}
#'   \item{est_2}{Estimate of the second parameter for the function described in 'distribution.'}
