...
| DVisMin | If the person is part of a visible minority group. |
...
For this demonstration, we will use the case of the test data for the city of Toronto. 
...
Or if you want to run with the original data set from Census, update the address and execute the following chunk: 
...
```{r export-summary-tab}
write.csv(pvalue_table_support[,c("Variable", "Description", "P_value",  "Significance")], paste0(diretorio_export_tables, "pvalue_table_release.csv"), row.names=FALSE)
